...
CREATE TABLE IF NOT EXISTS `pf_comments` (
  ...
  KEY `module_name_index` (`module_name`)
...
(1, 'yusuf', 'Muhammed Yusuf ERDEN', 'e10adc3949ba59abbe56e057f20f883e', 'cwyusef@gmail.com', '/assets/img/user2-160x160.jpg', '2017-07-13 15:09:31', 1, 3, NULL, '2017-07-25 05:36:33'),
