...
class Auths {
    ...
    function __construct()
    {
        ...
        // Load config
        $this->ci->config->load('authentication_s');
        $authentication_config = $this->ci->config->item('authentication_s');
        // Set config items
...
/* End of file Auths.php */
/* Location: ./application/libraries/Auths.php */